...
class Data:
    ...
    def read(self, start_day="jan6", end_day="jan12"):
        ...
        if dir_name not in os.listdir("C:\\Users\\Hp\\Downloads\\ESG_AI-main\\ESG_AI-main\\Data"):
            raise NameError(f"There isn't data for {dir_name}")

        data_path = os.path.join(".","C:\\Users\\Hp\\Downloads\\ESG_AI-main\\ESG_AI-main\\Data", dir_name)
